...
# based on https://github.com/martinkoehler/freetz-docker/blob/main/docker/dockerfile_master
...
# iproute2 ncftp iputils-ping net-tools (latest row): not necessary for building but uploading via tools/push_firmware
