...
writeFiles "$CACHE/$FILENAME" "$TARGET" "ubuntu:23.10" "$OVERWRITE" ' - Ubuntu 23'     "$UBUNTU_PATTERN"
writeFiles "$CACHE/$FILENAME" "$TARGET" "ubuntu:23.04" "$OVERWRITE" ' - Ubuntu 23'     "$UBUNTU_PATTERN"
