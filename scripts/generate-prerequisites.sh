...
writeFiles "$CACHE/$FILENAME" "$TARGET" "ubuntu:26.04" "$OVERWRITE" '- Ubuntu 23\/24\/25\/26' "$UBUNTU_PATTERN"
writeFiles "$CACHE/$FILENAME" "$TARGET" "ubuntu:24.04" "$OVERWRITE" '- Ubuntu 23\/24\/25\/26' "$UBUNTU_PATTERN"
...
writeFiles "$CACHE/$FILENAME" "$TARGET" "debian:14"    "$OVERWRITE" '- Debian 14'             "$DEBIAN_PATTERN"
...
writeFiles "$CACHE/$FILENAME" "$TARGET" "fedora:44"    "$OVERWRITE" '- Fedora 42/43/44'       "$FEDORA_PATTERN"
writeFiles "$CACHE/$FILENAME" "$TARGET" "fedora:43"    "$OVERWRITE" '- Fedora 42/43/44'       "$FEDORA_PATTERN"
writeFiles "$CACHE/$FILENAME" "$TARGET" "fedora:42"    "$OVERWRITE" '- Fedora 42/43/44'       "$FEDORA_PATTERN"
