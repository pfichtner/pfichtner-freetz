...
writePackageFile() {
	...
	{
		cat <<EOF
# This file is auto-generated by $(basename "$0") - do not edit manually.
...
writeFiles "$CACHE/$FILENAME" "$TARGET" "debian:forky" "$OVERWRITE" '- Debian 13/14'          "$DEBIAN_PATTERN"
writeFiles "$CACHE/$FILENAME" "$TARGET" "debian:13"    "$OVERWRITE" '- Debian 13/14'          "$DEBIAN_PATTERN"
